...
def format_single_linter_file(file_path: str, errors: list) -> dict:
    return {
        "errors": [format_linter_error(i) for i in errors[file_path]],
        "path": file_path,
        "status": "passed" if errors[file_path] == [] else "failed"
    }


def format_linter_report(linter_report: dict) -> list:
    return [
        format_single_linter_file(i, linter_report) for i in linter_report
    ]
